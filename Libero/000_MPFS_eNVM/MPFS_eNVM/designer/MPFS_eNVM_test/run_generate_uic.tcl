set_device \
    ...
    -pkg fcvg484
set_proj_dir \
    -path {Z:\Projects\PolarfireSoC_baremetal\Libero\000_MPFS_eNVM\MPFS_eNVM}
set_impl_dir \
    -path {Z:\Projects\PolarfireSoC_baremetal\Libero\000_MPFS_eNVM\MPFS_eNVM\designer\MPFS_eNVM_test}
